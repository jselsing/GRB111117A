...
\and V.~D'Elia\inst{13, 14}
\and A.~de~Ugarte~Postigo\inst{12, 1}
\and J.~P.~U.~Fynbo\inst{1}
\and A.~Gomboc\inst{15}
\and K.~E.~Heintz\inst{11,1}
\and A.~J.~Levan \inst{16}
\and S.~Piranomonte \inst{17}
\and G.~Pugliese \inst{10}
\and R.~S\'{a}nchez-Ram\'{\i}rez \inst{12, 18}
\and M.~Sparre\inst{1,19}
\and N.~R.~Tanvir\inst{20}
\and C.~C.~Th\"one\inst{12}
\and K.~Wiersema \inst{20}
}
