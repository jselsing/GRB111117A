...
The host lies in the brighter end of the expected sGRB host brightness distribution
...
should be missed due to host faintness for hosts at $z\sim2$. The high redshift of
...
where the duration T$_{90} < 2$ has been the standard dividing line between long
...
arriving first, where this lag is consistent with zero for sGRBs
...
profile and obtain $F_{H \alpha} > 4.1 \times 10^{-17} \mathrm{erg} \mathrm{s}^{-1} \mathrm{cm}^{-2}$. After converting the \citet{Kennicutt1998} relation to a
...
the lGRB afterglows \citep{Campana2010, Starling2013, Arcodia2016}. This is similar to what is found by
\citet{Kopac2012, Margutti2013}, that $N_H$ seems to be comparable for long and
short GRBs when compared at similar redshifts.
