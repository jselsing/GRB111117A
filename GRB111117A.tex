...
traced by the hosts of long GRBs (lGRBs).

The host lies in the brighter end of the expected sGRB host brightness
distribution at $z = 2.211$, and is actively forming stars. Using the host as a
benchmark for redshift determination, we find that between 43 and 71 per cent of
all \textit{Swift}-detected sGRBs are too faint at $z\sim2$ to allow for a secure
redshift determination. The high redshift of GRB~111117A is evidence against a
lognormal delay-time model for sGRBs through the predicted redshift distribution
of sGRBs, which is very sensitive to high-$z$ sGRBs.
...
exhibit a spatial extent of $\sim$ 1\farc5 and show significant velocity
...
2\farc0. Because image quality ranges from 0\farc6 - 1\farc7 and the galaxy
...
site of GRB~111117A of 1\farc25 $\pm$ 0\farc20 arcsec and \citet{Sakamoto2013}
find a corresponding offset of 1\farc0 $\pm$ 0\farc20 arcsec. This corresponds
