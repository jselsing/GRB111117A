...
nature of the host galaxy as well as physical parameters of the GRB. The rest-frame X-ray derived hydrogen column density, for example, is high compared to a
...
progenitor is a pair of inspiralling NSs. This constraint excludes some of the
...
Because the projected distance does not change much between $z = 1.3$ and $z =
...
As already pointed out \citep{Margutti2012, Sakamoto2013}, GRB~111117A is securely 
classified as belonging to the short class of GRBs. Because the observed classification
...
being a sGRB. Compared to the other two sGRB candidates at high redshift, GRB~060121
...
high $N_\mathrm{H}$, almost no dust is present.
