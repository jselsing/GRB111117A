...
M$_\odot$. Because we are viewing the host at an angle, this value is an upper
limit, which should be divided by $\sin(i)$, where $i$ is the inclination
relative to edge-on.
...
the lGRB afterglows \citep{Arcodia2016}. This is similar to what is found by
